    ...
    return (
        ...
        >
            <LandingHeroImage
                ...
                webpSrc="/images/Home/HomeHero.webp"
                alt="Fondo del hero"
                className="absolute inset-0 -z-30 h-full w-full object-cover object-[52%_center]"
            />
            <LandingContainer>
                <div className="grid items-start pt-48 sm:min-h-[760px] sm:items-center sm:py-14 lg:min-h-[820px] lg:grid-cols-[0.52fr_0.48fr] lg:py-0">
                    <div className="z-10 pb-6 sm:pt-28 sm:pb-10 lg:pt-20">
                        <h1
                        ...
                        >
                            ...
                            >
                                <DialogTrigger asChild>
                                    <button
                                        type="button"
                                        className="landing-action landing-video-trigger mt-6 inline-flex min-w-52 items-center justify-center gap-3 rounded-xl bg-[#c9003c] px-7 py-3 text-sm font-bold text-white shadow-[0_12px_24px_rgba(122,0,38,0.25)] hover:bg-[#ad0034]"
                                    >
                                        <span>Ver video</span>
                                ...
                                >
                                    ...
                                    <DialogDescription className="sr-only">
                                        Video informativo de Women&apos;s Health
                                        Clinic.
                                    </DialogDescription>
                                    <div className="overflow-hidden rounded-xl border border-[#f0d4df] bg-[#09123f]">
                                        <video
                                            src={homeVideoUrl}
                                            className="block h-auto max-h-[calc(100dvh-7rem)] w-full object-contain"
                                            controls
                                            autoPlay
                                            playsInline
                                        />
            ...
            <LandingHeroImage
                ...
                webpSrc="/images/Home/Doctors.webp"
                alt="Doctores de Women's Health Clinic"
                className="pointer-events-none relative left-1/2 z-0 block w-[210vw] max-w-none -translate-x-1/2 sm:absolute sm:bottom-0 sm:-z-10 sm:w-[155vw] lg:w-[min(150vw,1520px)]"
            />
        </section>
    );
}

    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La autenticacion de dos factores esta activa. Escanea el codigo QR o ingresa la clave en tu app de autenticacion.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para terminar, escanea el codigo QR o ingresa la clave en tu app de autenticacion',
            buttonText: 'Continuar',
        };
